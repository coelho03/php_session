A ideia do projeto é entender a forma de se usar o "$_SESSION" da forma correta. Já o exemplo da atividade tem que ser uma validação de login com restrição de acesso.
